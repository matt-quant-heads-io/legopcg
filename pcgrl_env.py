...
class PcgrlEnv(gym.Env):
    ...
    def __init__(self, prob="binary", rep="narrow"):
        ...
        self._iteration = 0
        self._changes = 0
        self._max_changes = max(int(0.2 * self._prob._width * self._prob._height), 1) # Losing condition
        self._max_iterations = self._max_changes * self._prob._width * self._prob._height # Losing condition
